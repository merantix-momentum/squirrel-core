...
def data_frame_source(
    data_frame_source_path: tuple[str, URL, dict], engine: ENGINE, convert_row_to_dict: bool, itertuples_kwargs: dict
) -> tuple[Source, ENGINE]:
    ...
    source = Source(
        ...
        driver_kwargs={
            ...
            "convert_row_to_dict": convert_row_to_dict,
            "itertuples_kwargs": itertuples_kwargs,
        },
    )
