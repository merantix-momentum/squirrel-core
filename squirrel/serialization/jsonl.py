...
class JsonSerializer(SquirrelSerializer):
    ...
    def serialize_shard_to_file(
        ...
        **open_kwargs,
        ...
        Args:
            ...
            compression (str): Compression codec to use. Passed to :py:meth:`fs.open`. Defaults to "gzip".
    ...
    def deserialize_shard_from_file(
        fp: str, fs: t.Optional[AbstractFileSystem] = None, mode: str = "rb", compression: str = "gzip", **open_kwargs
    ) -> t.Iterable[t.Any]:
