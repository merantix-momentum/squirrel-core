...
class Composable:
    ...
    def compose(self, constructor: t.Type[Composable], *args, **kw) -> Composable:
        ...
        if (
            "source" in (param := inspect.signature(constructor).parameters)
            and param["source"].default is inspect.Parameter.empty
        ):
            raise ValueError(f"source argument in {constructor} should be omitted")
