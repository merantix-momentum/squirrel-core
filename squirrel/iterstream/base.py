...
from squirrel.dataset.stream_dataset import AsyncContent
from squirrel.iterstream.iterators import batched_, filter_, flatten_, map_, monitor_, shuffle_, take_, tqdm_
        ...
        Args:
            ...
            executor (concurrent.futures.Executor, dask.distributed.Client): an optional executor to be used.
                ...
                **Note** if the executor is provided, it will not be closed in this function even after the iterator
                ...
                In addition to the above mentioned standard executors, you can also pass `numba` to this argument.
                Then async_map will wrap the iterator inside a `numba.jit` decorator to speed up the iteration.
